...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PullProject.file_lines_per_message'
        db.add_column('message_converter_pullproject', 'file_lines_per_message',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PullProject.file_lines_per_message'
        db.delete_column('message_converter_pullproject', 'file_lines_per_message')
    ...
    models = {
        ...
        'message_converter.incomingmessage': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'file_name': ('django.db.models.fields.CharField', [], {'blank': 'True', 'null': 'True', 'max_length': '200'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
